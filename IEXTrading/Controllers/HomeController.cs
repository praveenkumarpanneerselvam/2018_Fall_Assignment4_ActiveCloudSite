...
namespace MVCTemplate.Controllers
{
    public class HomeController : Controller
    {
        ...
        ****/
        ...
        public IActionResult GetStrategyResults()
        {
            IEXHandler webHandler = new IEXHandler();
            List<Company> companies = webHandler.GetSymbolsForQuotes();
            List<StrategyResponse> quotes = webHandler.GetStratResults(companies);
